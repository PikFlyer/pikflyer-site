...
test("brand assets and Android release download are present", () => {
  const requiredFiles = [
    ...
    "../downloads/pikflyer-xiaochibang-android-v2.0.5.sha256",
    "../downloads/pikflyer-xiaochibang-android-v2.0.5.apk",
    "../credits.html",
    "../public/credits.html",
    "../public/downloads/pikflyer-xiaochibang-android-v2.0.5.apk",
