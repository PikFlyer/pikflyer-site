...
test("brand assets and Android release download are present", () => {
  const requiredFiles = [
    ...
    "../downloads/pikflyer-xiaochibang-android-v1.0.4.apk",
    "../downloads/pikflyer-xiaochibang-android-v1.0.4.aab",
    "../downloads/pikflyer-xiaochibang-android-v1.0.4.sha256",
    "../credits.html",
    "../public/credits.html",
    "../public/downloads/pikflyer-xiaochibang-android-v1.0.4.apk",
  ];
...
test("page points users at the current Android release", () => {
  assert.match(rootIndex, /downloads\/pikflyer-xiaochibang-android-v1\.0\.4\.apk/);
  assert.match(rootIndex, /Version 1\.0\.4/);
